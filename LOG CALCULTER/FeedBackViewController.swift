...
@objc class FeedBackViewController: UIViewController ,HttpWrapperDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.txtmessage.layer.borderColor  = UIColor(red: 255/255, green: 152/255, blue: 0/255, alpha: 1.0).cgColor
    ...
    func setTextFieldBorder(_ txt:UITextField, bottomLine:CALayer)
    {
        ...
        bottomLine.borderColor = hexStringToUIColor("#003449").cgColor
    ...
    func serviceCall()
    {
        if(self.isInternetAvailable())
        {
            ...
            let dic: [String: AnyObject] = [
                "AppName" : "Shrimad Bhagavad Gita - Shloka" as AnyObject,
