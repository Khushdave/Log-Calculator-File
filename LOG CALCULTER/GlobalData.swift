...
class GlobalData
{
    ...
    static var Base_URL = "https://zoo-animal-api.herokuapp.com/"
    ...
    {
        let alert = UIAlertController(title: "API CALL Demo", message: message, preferredStyle: UIAlertController.Style.alert)
